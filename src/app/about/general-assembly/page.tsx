...
import { FaCalendarAlt, FaChevronDown, FaChevronUp, FaSearch } from 'react-icons/fa';
...
const assemblyMeetings = [
  {
    ...
    date: "15 مارس 2023",
    description: "عقدت غرفة بيشة اجتماع الجمعية العمومية السنوي برئاسة سعادة رئيس مجلس الإدارة، وبحضور أعضاء مجلس الإدارة والمشتركين، حيث تم خلال الاجتماع مناقشة جدول الأعمال واستعراض التقرير السنوي وإقرار الميزانية للعام المالي القادم."
  },
  {
    id: 2,
    year: 2022,
  ...
  },
  {
    ...
    image: "/assembly-placeholder.jpg",
    date: "23 مارس 2016",
    description: "عقدت غرفة بيشة اجتماع الجمعية العمومية السنوي برئاسة سعادة رئيس مجلس الإدارة، وبحضور أعضاء مجلس الإدارة والمشتركين، حيث تم خلال الاجتماع مناقشة جدول الأعمال واستعراض التقرير السنوي وإقرار الميزانية للعام المالي القادم، كما أوصت الجمعية بالبدء في إنشاء مبنى الغرفة الجديد."
  }
];
          ...
          <div className={styles.meetingsContainer}>
            {filteredMeetings.length > 0 ? (
              filteredMeetings.map((meeting) => (
                <div key={meeting.id} className={`${styles.meetingCard} ${expandedMeeting === meeting.id ? styles.expanded : ''}`}>
                  <div className={styles.meetingHeader} onClick={() => toggleMeeting(meeting.id)}>
                    ...
                    <div className={styles.expandButton}>
                      {expandedMeeting === meeting.id ? <FaChevronUp /> : <FaChevronDown />}
                    </div>
                  </div>
                  ...
                  {expandedMeeting === meeting.id && (
                    <div className={styles.meetingContent}>
                      ...
                      <div className={styles.meetingActions}>
                        <button className={styles.actionButton}>عرض التقرير السنوي</button>
                        <button className={styles.actionButton}>عرض الصور</button>
                      </div>
                    </div>
                  )}
                </div>
