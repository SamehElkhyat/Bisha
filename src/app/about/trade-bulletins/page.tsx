...
import { FaCalendarAlt, FaDownload, FaEye, FaSearch, FaFilter } from 'react-icons/fa';
...
const tradeBulletins = [
  {
    ...
    fileSize: "3.2 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر يناير 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  },
  {
    id: 2,
    ...
    image: "/bulletin-placeholder.jpg",
    fileSize: "3.5 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر فبراير 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  },
  {
    id: 3,
    ...
    image: "/bulletin-placeholder.jpg",
    fileSize: "3.8 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر مارس 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  },
  {
    id: 4,
    ...
    image: "/bulletin-placeholder.jpg",
    fileSize: "3.4 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر ابريل 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  },
  {
    id: 5,
    ...
    image: "/bulletin-placeholder.jpg",
    fileSize: "3.6 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر مايو 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  },
  {
    id: 6,
    ...
    image: "/bulletin-placeholder.jpg",
    fileSize: "3.3 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر يونيو 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  },
  {
    id: 7,
    ...
    image: "/bulletin-placeholder.jpg",
    fileSize: "3.7 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر يوليو 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  },
  {
    id: 8,
    ...
    image: "/bulletin-placeholder.jpg",
    fileSize: "3.5 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر أغسطس 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  },
  {
    id: 9,
    ...
    image: "/bulletin-placeholder.jpg",
    fileSize: "3.4 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر سبتمبر 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  },
  {
    id: 10,
    ...
    image: "/bulletin-placeholder.jpg",
    fileSize: "3.6 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر أكتوبر 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  },
  {
    id: 11,
    ...
    image: "/bulletin-placeholder.jpg",
    fileSize: "3.3 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر نوفمبر 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  },
  {
    id: 12,
    ...
    image: "/bulletin-placeholder.jpg",
    fileSize: "3.8 MB",
    description: "النشرة التجارية الشهرية لغرفة بيشة لشهر ديسمبر 2025، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية."
  }
];
...
const TradeBulletinsPage = () => {
  ...
  const filteredBulletins = tradeBulletins.filter(bulletin => {
    ...
    const matchesMonth = selectedMonth === 'all' || bulletin.month === selectedMonth;
      ...
      <div className={styles.pageHeader}>
        <div className={styles.headerContent}>
          ...
          <p className={styles.pageDescription}>
            النشرات التجارية الشهرية لغرفة بيشة، تتضمن أهم الأخبار الاقتصادية والفعاليات والمناقصات والفرص الاستثمارية
          </p>
        </div>
      </div>
        ...
        <div className={styles.bulletinsGrid}>
          {sortedBulletins.length > 0 ? (
            sortedBulletins.map((bulletin) => (
              <div 
                key={bulletin.id} 
                className={`${styles.bulletinCard} ${isFlipped === bulletin.id ? styles.flipped : ''}`}
              ...
              >
                <div className={styles.bulletinInner}>
                  ...
                  <div className={styles.bulletinBack}>
                    <h3 className={styles.bulletinBackTitle}>{bulletin.title}</h3>
                    <p className={styles.bulletinDescription}>{bulletin.description}</p>
                    
                    <div className={styles.bulletinActions}>
                      <button className={`${styles.actionButton} ${styles.viewButton}`} onClick={(e) => e.stopPropagation()}>
                        <FaEye className={styles.actionIcon} />
                        <span>عرض النشرة</span>
                      </button>
                      
                      <button className={`${styles.actionButton} ${styles.downloadButton}`} onClick={(e) => e.stopPropagation()}>
