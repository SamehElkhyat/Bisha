      ...
      >
        ...
        >
          ...
          >
            ...
            <svg className={styles.xLogo} viewBox="0 0 24 24" aria-hidden="true">
              <g>
        ...
        <motion.div 
          ...
          ref={imageRef}
        >
          <motion.div className={styles.imageGlow} variants={glowVariants} animate="visible"></motion.div>
          <motion.div 
