...
const ServicesPage = () => {
  const services = [
    ...
    { href: 'https://www.sdb.gov.sa/ar/تمويل-المنشات/تمويل-رواد-الاعمال', label: 'قنوف لتمويل رواد الاعمال', external: true },
    { href: 'https://bishacci.org.sa/?page_id=11593', label: 'مبادرة حلول لتحديات قطاع الاعمال', external: true },
    ...
    { href: 'https://bishacci.org.sa/?page_id=14839', label: 'مركز ريادة الاعمال الرقمي', external: true },
